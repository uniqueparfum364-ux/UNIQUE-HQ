...
# --- 3. PAGE: CRM (THE SALES HUB) ---
    ...
    try:
        ...
        st.error(f"Waiting for Google Sheets connection... Make sure the Sheet is shared! Error: {e}")
    ...
    with st.expander("➕ Capture New Event Lead"):
        with st.form("new_lead_form", clear_on_submit=True):
            ...
            if st.form_submit_button("🚀 Secure & Sync to Google"):
                ...
                # Push the new row to the Google Sheet
